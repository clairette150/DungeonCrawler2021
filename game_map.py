...
from tile_type import TileType, ground, wall, water, altar, grass, unknown
...
class GameMapEncoder(JSONEncoder):
    def default(self, object):
		# TODO: make a obj that is seriallizable and parent of every other object
        if isinstance(object, GameMap) or isinstance(object, Tile) or isinstance(object, TileType):
...
if __name__ == "__main__":
    ...
    game_map.make_board()  
    game_map_json = GameMapEncoder().encode(game_map)
    print(game_map_json)
